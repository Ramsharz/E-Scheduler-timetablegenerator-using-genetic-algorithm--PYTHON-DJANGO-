...
def evolutionary_algorithm(matrix, data, free, filled, groups_empty_space, teachers_empty_space, subjects_order):
    ...
    It uses (1+1) evolutionary strategy.
    """
    n = 3
    sigma = 2
    run_times = 5
...
def main():
    ...
    """
    filled = {} # index of classes that are occupied.
    subjects_order = {} 
    groups_empty_space = {} # index of a group's empty slots. (Group = Semester+Section)
    teachers_empty_space = {} # index of teacher's empty slots.
    file = 'data.txt'

    # data gets input data from the JSON file. it contains(classes, classrooms, teachers and groups.) 
